...
new_window() {
    ...
    tmux new-window "zsh $0 do_action" >/dev/null 2>&1
}
...
do_action() {
    ...
    local cmd="zsh $0 panes_src $cur_id"
    ...
    selected=$(FZF_DEFAULT_COMMAND=$cmd SHELL=$(command -v zsh) fzf -m --preview="$preview_cmd" \
